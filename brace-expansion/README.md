<h2>1087. Brace Expansion</h2><h3>Medium</h3><hr><div><p>You are given a string <code>s</code> representing a list of words. Each letter in the word has one or more options.</p>
